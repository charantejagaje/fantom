...
export const PRECISION_METAL_UNITS: PrecisionMetalUnit[] = [
  {
    ...
    boundingBoxes: [
      { id: 'b1', name: 'Scratch', xmin: 26, ymin: 18, xmax: 185, ymax: 72, confidence: 0.94 },
      { id: 'b2', name: 'Scoring', xmin: 44, ymin: 88, xmax: 172, ymax: 135, confidence: 0.91 }
    ],
    localImageUrl: '/dataset/neu_det/scratches/scratches_1.jpg',
    remoteImageUrl: 'https://images.unsplash.com/photo-1504917599217-d4dc5ebe6122?auto=format&fit=crop&w=600&q=80',
    normalReferenceUrl: 'https://images.unsplash.com/photo-1535813547-99c456a41d4a?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    hasLocalization: false, // Explicitly no bounding box in dataset
    relatedProcessVariables: {
      spindleRpm: 13100,
      vibrationMmSec: 5.9,
      coolantFlowLpm: 16.0,
  ...
  },
  {
    ...
    defect_type: 'Novel Multi-Harmonic Micro-Groove',
    defect_family: 'Surface',
    hasLocalization: true,
    boundingBoxes: [
      { id: 'b3', name: 'Micro-Groove', xmin: 65, ymin: 45, xmax: 140, ymax: 110, confidence: 0.58 }
    ],
    localImageUrl: '/dataset/neu_det/crazing/crazing_1.jpg',
    remoteImageUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=600&q=80',
    normalReferenceUrl: 'https://images.unsplash.com/photo-1535813547-99c456a41d4a?auto=format&fit=crop&w=600&q=80',
    relatedProcessVariables: {
      spindleRpm: 0,
      vibrationMmSec: 2.1,
  ...
  },
  {
    ...
    hasLocalization: true,
    boundingBoxes: [
      { id: 'b4', name: 'Inclusion', xmin: 78, ymin: 60, xmax: 125, ymax: 115, confidence: 0.88 }
    ],
    localImageUrl: '/dataset/neu_det/inclusion/inclusion_1.jpg',
    remoteImageUrl: 'https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&w=600&q=80',
    normalReferenceUrl: 'https://images.unsplash.com/photo-1535813547-99c456a41d4a?auto=format&fit=crop&w=600&q=80',
    relatedProcessVariables: {
      spindleRpm: 0,
      vibrationMmSec: 1.2,
